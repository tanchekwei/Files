...
namespace Files.App
{
	public static class Constants
	{
		...
		public static class GitHub
		{
			...
			public const string FeatureRequestUrl = @"https://github.com/tanchekwei/test-issue/issues/new?labels=feature+request&template=feature_request.yml";
			public const string BugReportUrl = @"https://github.com/tanchekwei/test-issue/issues/new?labels=bug&template=bug_report.yml";
